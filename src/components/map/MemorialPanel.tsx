...
export function MemorialPanel({
  ...
  return (
    <div className="absolute top-16 left-4 z-20 w-[560px] max-h-[calc(100vh-120px)] flex flex-col bg-white/97 backdrop-blur-md border border-border rounded-sm shadow-xl overflow-hidden">
