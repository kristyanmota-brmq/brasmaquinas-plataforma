...
**Arquivo:** `tasks/TASK-084-revisao-rt-1.md` · **Relatório:** `docs/relatorios/2026-06-12-TASK-084.md`

> RT revisou o doc 14 e ditou: 5035 3,5×2,5 removido do catálogo; agronomia (item 2) aprovada integral; §3.1 didática nova (orientação com exemplos numéricos); lateral família LF com **Dint real 48,1 mm**; **C=140**; nomenclatura "secundária"; **secundária v ≤ 2,5 m/s**; **rede secundária+lateral 100% PN40** (família LF no sizing, avaliador e BOM; principal/adutora PN80; gate de pressão por derivação protege os 40 mca). Recalibração: limiares de split (capacidade ~21 asp), benchmarks C=140, filtros de descrição.

---

### TASK-083 — Lateral única DN50 PN40 (revoga telescopia) + dossiê de fundamentos (doc 14)

**Status:** `concluída`
**Prioridade:** P1-crítico
**Classe:** A — motor de layout + documental
**Área:** layout / metodologia
**Arquivo:** `tasks/TASK-083-lateral-unica-dn50.md`
**Concluída em:** 2026-06-12 · **1032/1032 testes vitest** · 0 erros tsc · 37/37 tooling
**Relatório:** `docs/relatorios/2026-06-12-TASK-083.md`
**Autorização:** ordem do RT em sessão ("somente tubo de 50mm PN40") + pedido do dossiê de fundamentos

> Lateral é SEMPRE DN50 PN40: telescopia 75→50 (TASK-074) revogada; sem upgrade de diâmetro; coluna que não cabe DIVIDE (split — encurta, não engorda); gates preservados (2,5 m/s; 20%·Ps; Dint 46). Tê de redução 75×50 fora da BOM. 23 testes recalibrados (T74 → guarda da regra nova; fixtures de comportamento com vazão sintética; snapshot P 46→92 colunas físicas). **Doc 14 novo**: dossiê completo de fundamentos técnicos (equipamento, agronomia, orientação altimetria→planimetria→geometria, laterais, setorização+restrições, fishbone/mediana, candidatos de principal, solver HW, bomba, UTM, gates, calibráveis pendentes, referências) com campo de assinatura do RT.
